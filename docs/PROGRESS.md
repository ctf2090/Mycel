...
3. expand `M3` reader workflows carefully on top of the now-usable accepted-head inspection, render, editor-admission-aware profile base, and bounded viewer score surfaces while keeping broader governance persistence, profile ergonomics, and final dual-role closure explicit
...
| `M3` | Early partial | accepted-head reader workflows, bundle/store rendering with clearer ancestry context, named fixed-profile reading, editor-admission-aware inspect/render flows, bounded viewer score surfaces in head inspection, initial filtered/sorted/projected `view` governance inspect/list/publish workflows, and persisted reverse governance indexes | broader governance persistence, richer governance tooling, reader profile ergonomics, and final dual-role closure |
...
| 9. Views and Head Selection | Mostly done | `M3` | deterministic selector core, named fixed-profile selection, separate editor/view admission-aware inspect/render flows, and bounded viewer score channels in head inspection exist; broader governance persistence and final dual-role closure remain |
