...
Status: late partial progress, M1 parsing, parser / verify / CLI strictness coverage, fixture isolation, test-foundation cleanup, and canonical reproducibility core nearly complete
...
- [ ] Finish the remaining malformed field-shape depth, inspect-surface parity, and semantic edge-case closure required after the recent strictness-surface expansion.
