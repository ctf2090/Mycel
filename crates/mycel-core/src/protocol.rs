...
mod tests {
    ...
    fn wire_protocol_hello_example() -> Value {
        json!({
            "type": "HELLO",
    ...
    fn wire_protocol_manifest_example() -> Value {
        json!({
            "type": "MANIFEST",
            "version": "mycel-wire/0.1",
    ...
    fn wire_protocol_heads_example() -> Value {
        json!({
            "type": "HEADS",
            "version": "mycel-wire/0.1",
    ...
    fn wire_protocol_want_example() -> Value {
        json!({
            "type": "WANT",
            "version": "mycel-wire/0.1",
            "msg_id": "msg:want-001",
    ...
    fn wire_protocol_object_example() -> Value {
        json!({
            "type": "OBJECT",
            "version": "mycel-wire/0.1",
            "msg_id": "msg:obj-001",
    ...
    fn wire_protocol_snapshot_offer_example() -> Value {
        json!({
            "type": "SNAPSHOT_OFFER",
            "version": "mycel-wire/0.1",
            "msg_id": "msg:snap-001",
    ...
    fn wire_protocol_view_announce_example() -> Value {
        json!({
            "type": "VIEW_ANNOUNCE",
            "version": "mycel-wire/0.1",
            "msg_id": "msg:view-001",
    ...
    fn wire_protocol_bye_example() -> Value {
        json!({
            "type": "BYE",
            "version": "mycel-wire/0.1",
            "msg_id": "msg:bye-001",
    ...
    fn wire_protocol_error_example() -> Value {
        json!({
            "type": "ERROR",
            "version": "mycel-wire/0.1",
            "msg_id": "msg:err-001",
    ...
    fn concrete_wire_object_example() -> Value {
        let mut body = json!({
            "type": "patch",
            "version": "mycel/0.1",
    ...
    fn wire_required_string(object: &Map<String, Value>, field: &str) -> Result<String, String> {
    ...
    fn parse_wire_envelope_example(value: &Value) -> Result<(String, Map<String, Value>), String> {
        ensure_supported_json_values(value)?;
        let object = value
            .as_object()
    ...
    fn validate_wire_object_payload_behavior(payload: &Map<String, Value>) -> Result<(), String> {
    ...
    fn validate_wire_payload_example(
        message_type: &str,
        payload: &Map<String, Value>,
    ) -> Result<(), String> {
        match message_type {
            ...
            "OBJECT" => {
                validate_canonical_object_id(
                    &wire_required_string(payload, "object_id")?,
                    "object_id",
                )
                .map_err(|error| error.to_string())?;
