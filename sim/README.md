...
Minimal `validate sim/peers --json` shape example:

```json
{
  "status": "ok",
  "root": "/workspaces/Mycel",
  "target": "/workspaces/Mycel/sim/peers",
  "fixture_count": 4,
  "peer_count": 1,
  "topology_count": 4,
  "test_case_count": 4,
...
Minimal `validate fixtures/object-sets/minimal-valid/fixture.json --json` shape example:

```json
{
  "status": "ok",
  "root": "/workspaces/Mycel",
  "target": "/workspaces/Mycel/fixtures/object-sets/minimal-valid/fixture.json",
  "fixture_count": 1,
  "peer_count": 1,
  "topology_count": 1,
  "test_case_count": 1,
...
- `sim/negative-validation/smoke.py` runs one positive and one intentional negative validation path together
...
- GitHub Actions now runs `./sim/negative-validation/smoke.py --summary-only` in CI alongside Rust formatting, compile, and workspace test checks
