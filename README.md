...
- `client-non-discretionary-multi-view`
  - `EN`: [DESIGN-NOTES.client-non-discretionary-multi-view.en.md](./DESIGN-NOTES.client-non-discretionary-multi-view.en.md) explains a reader model where the active accepted head is derived from a fixed profile instead of local user choice
  - `zh-TW`: [DESIGN-NOTES.client-non-discretionary-multi-view.zh-TW.md](./DESIGN-NOTES.client-non-discretionary-multi-view.zh-TW.md) provides the Traditional Chinese explanation of the same profile-locked multi-view reader model
