...
| `M2` | Substantially underway | replay, `state_hash`, store rebuild, persisted indexes, narrow write path, conservative merge authoring with basic structural move/reorder coverage | stronger replay/store fixtures, broader core reuse, nested/reparenting merge breadth |
