...
- `client-non-discretionary-multi-view`
  - `EN`：[DESIGN-NOTES.client-non-discretionary-multi-view.en.md](./DESIGN-NOTES.client-non-discretionary-multi-view.en.md)，說明 reader model（閱讀端模型）中，active accepted head 由固定 profile 導出，而不是由使用者本地選擇
  - `zh-TW`：[DESIGN-NOTES.client-non-discretionary-multi-view.zh-TW.md](./DESIGN-NOTES.client-non-discretionary-multi-view.zh-TW.md)，提供同一個 profile-locked（設定檔鎖定）multi-view 閱讀模型的繁體中文說明
