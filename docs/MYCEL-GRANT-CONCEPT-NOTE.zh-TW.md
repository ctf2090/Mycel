...
**Mycel：可驗證文本歷史、受治理閱讀狀態與去中心化複製**

## 摘要

Mycel 是一個面向文本系統的開放協議棧，適用於同時需要下列能力的場景：

- 可驗證的 revision 歷史
- 受治理的預設閱讀結果
- 不依賴強制全域共識的去中心化複製

它特別適合長期文本、評註系統、受治理的參考文本集合，以及其他要求歷史、詮釋與審計能力必須長期保留，且允許多個有效分支並存的環境。
...
- 更強的 open protocol core，支撐可驗證文本系統
...
- 作為未來 text-governance 與 commentary applications 的 reference base
...
Mycel 雖然仍在早期，但已經從純概念前進到具體的 spec、implementation 與 validation 路徑。此階段的支持，將有助於把一個有潛力的協議方向，推進成為可用於受治理文本系統的公共基礎設施。
