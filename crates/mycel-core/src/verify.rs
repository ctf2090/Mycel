...
mod tests {
    ...
    fn verify_strict_id_case_summary(
        kind: &str,
        id_field: &str,
        id_value: Value,
        ...
        match kind {
            ...
            "revision" => {
                let revision_id = super::recompute_object_id(&value, "revision_id", "rev")
    ...
    fn strict_id_type_errors_are_rejected(
        #[case] kind: &str,
        #[case] id_field: &str,
    ...
    fn strict_id_prefix_errors_are_rejected(
        #[case] kind: &str,
        #[case] id_field: &str,
        #[case] invalid_value: Value,
        #[case] expected_error: &str,
    ...
    #[test]
    fn patch_wrong_block_reference_prefix_is_rejected() {
        let (signing_key, public_key) = signer_material();
        let mut patch = json!({
            "type": "patch",
            "version": "mycel/0.1",
    ...
    #[test]
    fn patch_empty_metadata_entries_are_rejected() {
        let (signing_key, public_key) = signer_material();
        let mut patch = json!({
            "type": "patch",
            "version": "mycel/0.1",
