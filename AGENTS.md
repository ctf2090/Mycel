...
- If a completed work cycle was working against a GitHub issue, update that issue after the work cycle with the current outcome, landed commit or push status, verification status, and the next recommended follow-up. <!-- item-id: workflow.github-issue-update-after-cycle -->
...
- In the final reply for every completed work cycle, include a rough estimated token-usage figure or range for that cycle, and clearly label it as an estimate unless an observed UI or API value is being reported instead. <!-- item-id: workflow.report-estimated-token-usage -->
