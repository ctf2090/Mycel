...
The forum app layer should follow six rules.
...
2. fixture-backed sample objects for one board, one thread, and one moderation split
3. a reader-surface note for thread rendering and trace inspection
