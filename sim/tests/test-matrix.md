...
- `session-unadvertised-revision-want-after-manifest`: reject a sync transcript that emits `WANT` for a revision outside the accepted sync roots established by `MANIFEST`
